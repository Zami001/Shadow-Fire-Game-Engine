...
void msdfGeneratorNew(const msdfgen::BitmapRef<float, 3>& output, const GlyphGeometry& glyph, const GeneratorAttributes& attribs) {
...
void Font::test() {
    ...
    //if (ft) {
    //    FontHandle* font = loadFont(ft, "C:\\Windows\\Fonts\\ALGER.ttf");
    //    if (font) {
    //        Shape shape;
    ...
    if (msdfgen::FreetypeHandle* ft = msdfgen::initializeFreetype()) {
        // Load font file
        if (msdfgen::FontHandle* font = msdfgen::loadFont(ft, "C:\\Windows\\Fonts\\ALGER.ttf")) {
            ...
            ImmediateAtlasGenerator<
                ...
                &msdfGeneratorNew, // function to generate bitmaps for individual glyphs
